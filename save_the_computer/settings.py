"""
Django settings for save_the_computer project.
...
# Directory to save media files and that URL (in ImageField)
MEDIA_ROOT = os.environ.get('DJANGO_MEDIA_ROOT') or os.path.join(BASE_DIR, '/media/')
MEDIA_URL = '/media/'
...
# save-the-computer Configuration
STCOMPUTER_COLLECTORS = [
    {
        'collector': 'CPU',
        'page_limit': 3
    },
